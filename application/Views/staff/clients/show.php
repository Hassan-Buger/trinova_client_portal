...
<style>
    ...
    .cp-layout{display:grid;grid-template-columns:minmax(0,1.9fr) minmax(290px,.85fr);gap:20px;margin-top:20px;align-items:start}.cp-main,.cp-side{display:flex;min-width:0;flex-direction:column;gap:18px}.cp-side{position:sticky;top:18px}
